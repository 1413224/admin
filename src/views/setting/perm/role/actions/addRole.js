...
export default {
  ...
  submitManage(formName){
    ...
    this.$refs[formName].validate((valid)=>{
      ...
      if(_this.isEdit){
        url = _this.baseUrl + _this.url.commonPermGroup.EditById
        params.id = _this.$route.query.id
      }else {
        url = _this.baseUrl + _this.url.commonPermGroup.Add
        params.role_type = _this.url.role_type
