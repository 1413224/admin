            ...
            <el-collapse v-model="activeNames" class="collapse">
              <el-collapse-item 
                ...
                <div class="item-collapse"
                  ...
                  <el-checkbox :indeterminate="itm.isIndeterminate" class="checkall pl-1 py-1" 
                    v-model="itm.checkAll" @change="checked => handleCheckAllChange(checked,itm,idx)">
                    {{itm.name}}
                  </el-checkbox>
                  <div class="list bg-gray py-1 pl-4" v-if="itm.children.length!=0">
                    <el-checkbox-group
                      v-model="itm.checkedCities" @change="value => handleCheckedCitiesChange(value,itm,idx)">
