export default {
  ...
  setInfo(data){
    ...
    _this.ruleForm.grPage = data.website
    // 紧急联系人
    _this.ruleForm.lxrType = data.emergency_info.emergency_type ? data.emergency_info.emergency_type.toString() :''
    ...
    _this.ruleForm.bloodType = data.other_info.blood_type ? data.other_info.blood_type.toString() : ''
    _this.ruleForm.height = data.other_info.stature
    _this.ruleForm.weight = data.other_info.weight
    _this.ruleForm.education = data.other_info.education ? data.other_info.education.toString() : ''
